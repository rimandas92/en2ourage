...
const URL = 'mongodb://brain1uMMong0User:PL5qnU9nuvX0pBa@nodeserver.mydevfactory.com:27017/En2ourage?authSource=admin';
...
getConnection = async (req, res) => {
  try {
    ...
    console.log("En2ourage Database Connected to the MongoDB Atlus");
  } catch (error) {
